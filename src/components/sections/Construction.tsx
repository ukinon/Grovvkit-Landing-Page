...
export default function Construction() {
  return (
    <div className="w-screen h-screen fixed z-50 bg-gradient-to-bl from-secondary-foreground to-primary ">
      <div className="flex flex-col w-full gap-4 h-full justify-center items-center">
        ...
        <Image
          ...
          height={100}
          alt=""
          className="md:w-1/3 md:h-1/2 h-1/2 w-full"
        />
        <h1 className="font-mocheBold text-secondary md:text-3xl">
          Website is under construction..
        </h1>
        <div className="flex flex-col justify-center items-center gap-3">
          <p className="font-moche text-secondary-foreground">
            Want to ask us about something? Contact us here:
          </p>

          <div className="flex flex-row gap-3 items-center">
            <a href="https://instagram.com/grovvkit" target="_blank">
              <InstagramLogoIcon className="text-secondary-foreground size-[5vh] md:size-[2vw]" />
            </a>
            <p className="text-secondary text-xl"> | </p>
            <a
              href="https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=grovvkit.studio@gmail.com"
              target="_blank"
            >
              <SiGmail className="text-secondary-foreground size-[5vh] md:size-[2vw]" />
            </a>
          </div>
        </div>
      </div>
